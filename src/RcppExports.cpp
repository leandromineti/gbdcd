...
RcppExport SEXP _gbdcd_RcppPartition(SEXP neighborsSEXP, SEXP centersSEXP) {
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(RcppPartition(neighbors, centers));
...
static const R_CallMethodDef CallEntries[] = {
    {"_gbdcd_RcppPartition", (DL_FUNC) &_gbdcd_RcppPartition, 2},
